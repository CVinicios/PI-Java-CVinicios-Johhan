...
public class Loja
{
	...
	public void AdicionarVeiculo()
	{
		...
		if(carroOuMoto == Veiculo.CARRO)
		{
			while(!loop)
			{
				try
				{
					System.out.println("Digite numero correspondente ao cambio:(0)AUTOMATICO (1)SEMI-AUTOM�TICO (2)MANUAL");
		...
		while(!loop)
		{
			try
			{
				System.out.println("Digite numero correspondente � cor: (0)ROSA (1)VERMELHO (2)AZUL (3)AMARELO (4)PRETO");
		...
		while(!loop)
		{
			if(carroOuMoto == Veiculo.CARRO)
			{
				try
				{
					System.out.println("Digite numero correspondente � montadora: (0)HONDA, (1)HYUNDAI, (2)MITSUBISHI");
			...
			}else
			{
				try
				{
					System.out.println("Digite numero correspondente � montadora: (4)COBRA, (5)YAMAHA");
					montadora = Marca.values()[scan.nextInt()];
					loop = true;
				}
				catch(ArrayIndexOutOfBoundsException exception)
		...
		while(!loop)
		{
			try
			{
				System.out.println("Digite o pre�o do Veiculo");
	...
	public void RemoverVeiculo()
	{
		...
		if(carroFound==-1)
			System.out.println("O veiculo n�o foi encontrado");
		else
